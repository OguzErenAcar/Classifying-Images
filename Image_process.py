        ...
        for i in range(len(Cell_direction)):  # i yatay 32 cell
            ...
            for j in range(len(Cell_direction[i])):  # j 32 cell içinde
                ...
                for k in range(len(Cell_direction[i, j])):  # bir değer=k
                    ...
                    k2 = abs(direction - ust)
                    div = magnitude / (k1 + k2)
                    histogram[alt_index] += div * k2
                    histogram[t] += div * k1
